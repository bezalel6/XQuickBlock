...
export const upsaleTwitterPathname = 'i/verified-get-verified'
export const buyIntoUpsaleHref = "/i/premium_sign_up"
export const upsaleSelectors = ['[data-testid="verified_profile_upsell"]', `aside:has( a[href="${buyIntoUpsaleHref}"])`]
