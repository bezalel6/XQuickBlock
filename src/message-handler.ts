 ...
 */
export async function handleSettingsChange(settings: ExtensionSettings): Promise<void> {
 ...
 */
export async function processPopupUpdate(payload: ExtensionSettings): Promise<void> {
 ...
 * @returns Promise that resolves with the response
 */
export async function sendMessageToContentScript(message: ExtensionMessage): Promise<any> {
 ...
 */
export async function handleStateUpdate(payload: ExtensionSettings): Promise<ExtensionSettings> {
